...
;Ajustes de interfaz
    ...
    !define MUI_HEADERIMAGE_BITMAP "apphotel.bmp"
...
;Selector de idioma
    ...
    !define MUI_LANGDLL_REGISTRY_KEY "Software\AppHotel" 
...
Section "Principal" MainSec
    ...
    WriteUninstaller "$INSTDIR\UnistallAppHotel.exe"
...
!insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\AppHotel\AppHotel.lnk" "$INSTDIR\sAppHotelv3.jar"
    CreateShortCut "$SMPROGRAMS\AppHotel\AppHotel.lnk" "$INSTDIR\UninstallAppHotel.exe"
...
Section "Desisntalador"
    Delete "$INSTDIR\UnistallAppHotel.exe"
